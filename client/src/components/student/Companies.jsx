...
const Companies = () => {
    return (
        <div className='pt-16'>
            ...
            <div className='md:flex md:flex-wrap grid grid-cols-2 items-center justify-center gap-16 md:gap-16 md:mt-10 mt-5'>
                ...
                <img src={assets.paypal_logo} alt="paypal" className='w-20 md:w-28 col-start-1 col-end-3 mx-auto' />
            </div>
        </div>
    )
}
